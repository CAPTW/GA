...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run constrained NSGA-II smoke validation.")
    parser.add_argument(
        "--problem",
        choices=["constrained_zdt_box_toy", "constrained_dtlz_box_toy"],
        default="constrained_zdt_box_toy",
    )
    ...
    parser.add_argument("--artifact-suffix", default="constrained_nsga2_smoke1")
